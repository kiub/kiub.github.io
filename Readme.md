...
```
You cannot deploy to the same branch you are working in. This will overwrite the source for your site.
First, back up your site's source to a branch:

git checkout -b source
git push origin source

With that, you'll work in the source branch and deploy to the master branch.
```
